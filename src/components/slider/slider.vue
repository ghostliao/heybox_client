<template>
<div class="cpt-slider" :class="sliderClass" tabindex="0"
  ...
  <div class="cpt-slider-track"></div>
  <div class="cpt-slider-fill" :style="fillStyle"></div>
  <div class="cpt-slider-thumb" :style="thumbStyle">
