        ...
        <div class="row row-1">
          ...
          <div class="layer" :class="{ 'hover': data.downloading }">
            ...
            <div class="info">
              ...
              <span v-show="data.downloading" class="download-size">{{ data.fileSize * data.downloadProgress | fileSize }}</span>
              <span v-show="data.downloading" class="download-size">/</span>
              <span class="full-size">{{data.fileSize|fileSize}}</span><br>
              <span class="wh">{{data.width}} × {{data.height}}</span>
            </div>
            <div class="btn-group">
              <!-- <div v-show="!data.downloadFinished" class="btn">
                <cpt-icon-button icon="download-fill"></cpt-icon-button>
              </div> -->
            </div>
          </div>
...
export default {
  ...
  methods: {
    wallpaperPreview () {
      if (this.$route.name !== 'wallpaper-store') return
